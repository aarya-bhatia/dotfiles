...
int test_resolve_path() {
  ...
  test_resolve_path_helper(".", "/home/aarya/dotfiles/scripts/bulkrename");
  test_resolve_path_helper("..", "/home/aarya/dotfiles/scripts");
  test_resolve_path_helper("./", "/home/aarya/dotfiles/scripts/bulkrename");
  test_resolve_path_helper("hello.pdf",
                           "/home/aarya/dotfiles/scripts/bulkrename/hello.pdf");
  ...
  test_resolve_path_helper(
      ...
      "/home/aarya/dotfiles/scripts/bulkrename/data/test1/test2/hello");
  ...
  test_resolve_path_helper(".../hello",
                           "/home/aarya/dotfiles/scripts/bulkrename/.../hello");
  test_resolve_path_helper("///", "/");
  test_resolve_path_helper("./..//~/~/~//", "/home/aarya");
